...
namespace Sistema_Pos
{
    public partial class Administrador : Base
    {
        ...
        private void Administrador_Load(object sender, EventArgs e)
        {
            ...
            lblAdministrador.Text = data.Tables[0].Rows[0]["IsAdmin"].ToString();
        ...
        {
            if(MessageBox.Show("¿Desea salir?", "Aviso",MessageBoxButtons.YesNo,MessageBoxIcon.Exclamation,MessageBoxDefaultButton.Button1)==DialogResult.Yes)
            { 
                Application.Exit();
            } 
        }
